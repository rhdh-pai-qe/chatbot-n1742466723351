...
3) Access the `workbench` named `chatbot-n1742466723351-notebook`.
...
5) In the terminal, run `cd chatbot-n1742466723351` to navigate to your sample app's directory.
